...
// if ft_printf find an error, it's going to print '(null)' and return len + 6 //
...
// ft_printf return the len of what it printed //

// *error is here if my write return -1, if this happens , ft_printf return -1 //
